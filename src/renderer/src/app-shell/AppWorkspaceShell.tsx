...
import { PRCommentsProvider } from '../components/pr-comments/pr-comments-store'
...
export function AppWorkspaceShell(props: {
  ...
  return (
    ...
    >
      {/* Why here: the Checks panel is mounted only while its tab is selected, but the diff viewer
          renders the same comment cards inline and outlives it. */}
      <PRCommentsProvider>
